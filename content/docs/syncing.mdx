...
<video
  ...
  poster={LANDING_VIDEOS.gitHandoff.cover.src}
  controls
>
  <source src={LANDING_VIDEOS.gitHandoff.webm} type="video/webm" />
  <source src={LANDING_VIDEOS.gitHandoff.mp4} type="video/mp4" />
