...
begin
  ...
  values (arg_value, concat(arg_key, '_', arg_organization_uuid), arg_description)
  returning id into var_new_vault_secret_id;
  
  -- now create the organization_key entry
  insert into public.organization_keys (organization_id, key, vault_secret_id)
  values (var_organization_id, arg_key, var_new_vault_secret_id);
