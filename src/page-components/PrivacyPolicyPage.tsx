        ...
        <div className="space-y-4">
          ...
          <section aria-label="Introduction">
            <P className="pt-6">
              ...
              from&nbsp;
              <a
                href="https://agentsmith.app/"
                className="underline hover:text-gray-600"
              >
                https://agentsmith.app
              </a>{' '}
              (the &quot;Site&quot;) or otherwise communicate with us
              (collectively, the &quot;Services&quot;). For purposes of this
          ...
          <section aria-label="Policy sections" className="space-y-8">
            ...
            <section aria-label="Direct Information Collection">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li className="text-foreground/80">
                  Application information including the prompts and agents you
                  create and manage.
                </li>
                <li className="text-foreground/80">
            ...
            <section aria-label="International Users">
              ...
              <p>
                ...
                equivalent contracts issued by the relevant competent authority
                of the UK, as relevant, unless the data transfer is to a country
                that has been determined to provide an adequate level of
                protection.
                <br />
              </p>
            </section>
