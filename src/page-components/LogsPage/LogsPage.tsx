...
import { LogItem } from '@/page-components/LogsPage/log-item';
...
type LogData = SupabaseTableData<'llm_logs'> & {
  prompt_versions: {
    uuid: string;
    version: string;
    prompts: {
...
const renderLogItem = (project: NonNullable<GetProjectDataResult>) => (log: any) => (
