...
export const AccountPage = () => {
  ...
  const [openJoinOrganizationModal, setOpenJoinOrganizationModal] = useState(false);
  ...
  return (
    <>
      <JoinOrganizationModal
        open={openJoinOrganizationModal}
        onOpenChange={setOpenJoinOrganizationModal}
      />
          ...
          <div className="flex flex-col gap-4 items-start">
            ...
            <div className="flex flex-col gap-2 items-start">
              ...
              <Button
                variant="link"
                className="p-0"
                onClick={() => setOpenJoinOrganizationModal(true)}
              >
