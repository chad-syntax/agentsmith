...
var require_signer = __commonJS({
  "../node_modules/fast-jwt/src/signer.js"(exports, module) {
    ...
    module.exports = function createSigner2(options) {
      let {
        key,
        algorithm,
        noTimestamp,
...
var Prompt = class {
  ...
  async compile(...args) {
    ...
    const finalGlobalContext = merge2(globals, globalOverrides);
  ...
  async execute(...args) {
    ...
    const finalConfig = merge2(this.version.config, configOverrides, {
      usage: {
        include: true
      }
    });
...
// src/AgentsmithClient.ts
var defaultAgentsmithDirectory = path.join(process.cwd(), "agentsmith");
var AgentsmithClient = class {
  ...
  async fetchGlobals() {
    try {
      ...
      const globalsJson = await fs2.promises.readFile(globalsJsonPath, "utf-8");
