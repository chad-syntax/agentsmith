...
var createJwtClient = (jwt, supabaseUrl, supabaseAnonKey) => {
  ...
  return (0, import_supabase_js.createClient)(
    supabaseUrl ?? "https://jcnpgqhjaoppfhbkcnpv.supabase.co",
    supabaseAnonKey ?? "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpjbnBncWhqYW9wcGZoYmtjbnB2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzgwMzA2OTUsImV4cCI6MjA1MzYwNjY5NX0.n_gN9QTv9qY7FlA8wyoww8Nd4PFv9EMiXiDgGOQ2Axw",
    {
      global: {
        headers: {
...
var AgentsmithClient = class {
  constructor(sdkApiKey, projectId, options = {}) {
    ...
    this.agentsmithApiRoot = options.agentsmithApiRoot ?? "https://agentsmith.app";
    this.supabaseUrl = options.supabaseUrl ?? "https://jcnpgqhjaoppfhbkcnpv.supabase.co";
    this.supabaseAnonKey = options.supabaseAnonKey ?? "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImpjbnBncWhqYW9wcGZoYmtjbnB2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzgwMzA2OTUsImV4cCI6MjA1MzYwNjY5NX0.n_gN9QTv9qY7FlA8wyoww8Nd4PFv9EMiXiDgGOQ2Axw";
